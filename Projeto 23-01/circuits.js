...
var vm = function () {
    ...
    self.toggleFavourite3 = function (id) {
    ...
    self.SetFavourites3 = function () {
        let storage3;
        try {
            storage3 = JSON.parse(localStorage.getItem("fav3"));
        } catch (e) {
            ;
        }
        if (Array.isArray(storage3)) {
            self.favourites3(storage3)
        }
    }
