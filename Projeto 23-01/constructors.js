...
var vm = function () {
    ...
    self.toggleFavourite2 = function (id) {
    ...
    self.SetFavourites2 = function () {
        let storage2;
        try {
            storage2 = JSON.parse(localStorage.getItem("fav2"));
        } catch (e) {
            ;
        }
        if (Array.isArray(storage2)) {
            self.favourites2(storage2)
        }
    }
